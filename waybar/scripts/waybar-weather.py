...
try:
    weather = requests.get("https://wttr.in/Addis_Ababa?format=j1").json()

    def format_time(time):
        return time.replace("00", "").zfill(2)

    # FIX 1: The function now correctly uses its argument
    def format_temp(temp_str):
        return (temp_str + "°C").ljust(4)
    ...
    for i, day in enumerate(weather["weather"]):
        ...
        # FIX 2: Changed maxtempF/mintempF to maxtempC/mintempC
